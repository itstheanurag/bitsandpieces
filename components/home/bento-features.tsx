...
export const BentoFeatures: React.FC = () => {
  return (
    <section className="py-32 relative overflow-hidden bg-background border-t border-border/60">
      {/* Background glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[400px] bg-primary/5 blur-[150px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <p className="inline-flex items-center gap-2 rounded-full border border-border/60 bg-muted/40 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.25em] text-muted-foreground mb-4">
            Features
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-[24rem]">
          ...
          <div className="lg:col-span-2 relative overflow-hidden rounded-[2.5rem] border border-border/60 bg-card/40 p-10 flex flex-col justify-between group shadow-sm">
          ...
          <div className="col-span-1 col-start-1 lg:col-start-3 relative overflow-hidden rounded-[2.5rem] border border-border/60 bg-[#09090b] p-10 flex flex-col justify-between group shadow-sm">
          ...
          <div className="col-span-1 lg:col-start-1 lg:row-start-2 relative overflow-hidden rounded-[2.5rem] border border-border/60 bg-card/40 p-10 flex flex-col justify-between group shadow-sm">
          ...
          <div className="lg:col-span-2 lg:col-start-2 lg:row-start-2 relative overflow-hidden rounded-[2.5rem] border border-border/60 bg-card/40 p-10 flex flex-col justify-between group shadow-sm">
