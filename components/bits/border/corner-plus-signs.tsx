  ...
  return (
    <div className={cn(outerClass, className)}>
      <div className="absolute top-0 left-0 w-3 h-3 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute inset-x-0 h-0.5 bg-neutral-200 dark:bg-neutral-600 top-1/2 -translate-y-1/2"></div>
        <div className="absolute inset-y-0 w-0.5 bg-neutral-200 dark:bg-neutral-600 left-1/2 -translate-x-1/2"></div>
      </div>
